...
**重要提示:** 当前已启用R18内容模式，可以讨论和分析成人内容，包括但不限于：
- 成人角色设定
- 性行为相关的角色特征
- 成人关系和情感设定
- 其他18+内容

在R18模式下，你应该以专业、客观的态度收集相关信息，不带价值判断。
"""
    else:
        base_prompt += """

**内容限制:** 当前为常规模式，请避免讨论成人内容。如果用户提及相关内容，请引导向合适的全年龄向内容。
"""
...
**R18内容处理:** 当前已启用R18内容模式，可以正常编写包含成人内容的角色提示词。请以专业的态度处理相关内容。
"""
    else:
        base_prompt += """
